...
export function readInputs() {
    ...
    for (let i = 0; i < visibleCreatureCount; i++) {
        ...
        game.creaturesVisibles.push(Object.assign(Object.assign({}, game.creaturesMetas.get(creatureId)), { x, y, vx, vy }));
    }
    ...
    for (let i = 0; i < radarBlipCount; i++) {
        ...
        game.radars.push(Object.assign(Object.assign({}, creature), { droneId, direction: radar }));
    }
}
